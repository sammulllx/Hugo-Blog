---
title: "My Third Post"
date: 2023-05-17T00:50:04+08:00
draft: false
---
...
2. **const**修饰的变量 `const 数据类型 常量名 = 常量值`
   ...
   - <mark>通常在变量定义前加关键字 const</mark>，修饰该变量为常量，不可修改
...
**作用：** 利用 sizeof 关键字可以<mark>统计数据类型所占内存大小</mark>
...
**作用：** 用于表示一些<mark>不能显示出来的 ASCII 字符</mark>
...
1. const 修饰指针 --- <mark>常量指针</mark>
2. const 修饰常量 --- <mark>指针常量</mark>
3. const 即修饰指针，又修饰常量
